  ...
  clearTasks(){
    ...
    while(i--) {
      if(tasks[i].completed === true) {
        ...
        axios.request({
          method: 'delete',
          url: 'https://api.mlab.com/api/1/databases/reacttasks/collections/tasks/' + id + '?apiKey=mb7H00lW6jqlpY2bgWAmNKfIE7YvH29m'
        }).then((response) => {
    ...
    return (
      <div className="App">
        ...
        <Container>
          ...
          <Button color="danger" onClick={this.clearTasks.bind(this)}>Clear Completed Tasks</Button>
        </Container>
      </div>
    );
  }
